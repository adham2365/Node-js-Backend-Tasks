...
authorRouter.get("/", validateParams(), async (req, res) => {
    // get all authors
...
authorRouter.get("/:id", validateParams(), async (req, res) => {
    // get author
...
authorRouter.patch("/:id", validateParams(), validateBody(authorSchema.partial()), async (req, res) => {
    // get id
...
authorRouter.delete("/:id", validateParams(), async (req, res) => {
    // get id
    const id = req.params.id;
